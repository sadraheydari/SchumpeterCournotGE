...
Create and initialize a `ProgressTracker`.

Must be called after first `diff` is computed.
"""
function ProgressTracker(tol::Float64; diff0::Float64=Inf, bar_length::Int=40, color::String=GREEN)
...
"""
function update!(pt::ProgressTracker, diff::Float64, iter::Int)
...
"""
function finish!(pt::ProgressTracker, iter::Int, diff::Float64)
    diff_str = @sprintf("%.3e", diff)
