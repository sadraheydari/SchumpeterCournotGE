...
innovation_success_prob(l:: Float64, e:: ModelEnvironment) = innovation_success_prob(l, e.param);
innovation_success_prob(l:: Float64, m:: DSCIModel) = innovation_success_prob(l, m.env);